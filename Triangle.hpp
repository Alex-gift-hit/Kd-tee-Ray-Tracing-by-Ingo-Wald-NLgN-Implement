...
public:
    ...
    Object::Side getSide(){return this->side;};
};
...
public:
    MeshTriangle(const std::string& filename)
    {
        ...
        std::cout<<"build sah!"<<std::endl;
        bvh = new BVHAccel(ptrs,bounding_box,1,BVHAccel::SplitMethod::SAH);
    }
    ...
    void setSide(Side side){this->side = side;}; // my add
    Object::Side getSide(){return this->side;};

    Bounds3 bounding_box;
    std::unique_ptr<Vector3f[]> vertices;
    uint32_t numTriangles; // unuse
...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    // very important for ACC, if we delete this ,time  will be 600sec than 6sec with it
